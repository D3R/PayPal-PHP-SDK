...
class WebhookEventTypeTest extends TestCase
{
     ...
     * @param WebhookEventType $obj
     */
    public function testSubscribedEventTypes(\PayPal\Api\WebhookEventType $obj, $mockApiContext): void
    {
     ...
     * @param WebhookEventType $obj
     */
    public function testAvailableEventTypes(\PayPal\Api\WebhookEventType $obj, $mockApiContext): void
    {
        $mockPPRestCall = $this->getMockBuilder(\PayPal\Transport\PayPalRestCall::class)
            ->disableOriginalConstructor()
            ->getMock();
