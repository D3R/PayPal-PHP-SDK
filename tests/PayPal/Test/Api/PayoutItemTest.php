...
class PayoutItemTest extends TestCase
{
     ...
     */
    public static function getObject(): \PayPal\Api\PayoutItem
    {
     ...
     */
    public function testSerializationDeserialization(): \PayPal\Api\PayoutItem
    {
     ...
     */
    public function testGet(\PayPal\Api\PayoutItem $obj, ?\PHPUnit_Framework_MockObject_MockObject $mockApiContext): void
    {
     ...
     * @dataProvider mockProvider
     */
    public function testCancel(\PayPal\Api\PayoutItem $obj, ?\PHPUnit_Framework_MockObject_MockObject $mockApiContext): void
    {
        $mockPPRestCall = $this->getMockBuilder(\PayPal\Transport\PayPalRestCall::class)
            ->disableOriginalConstructor()
            ->getMock();
