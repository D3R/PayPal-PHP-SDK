...
$createProfileResponse = require_once __DIR__ . '/CreateWebProfile.php';
...
try {
    ...
    ResultPrinter::printError("Deleted Web Profile", "Web Profile", $createProfileResponse->getId(), null, $payPalConnectionException);
    exit(1);
}
